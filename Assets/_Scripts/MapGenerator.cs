...
public class MapGenerator : MonoBehaviour {
    ...
    public void DrawMapInEditor()
    {
        ...
        {
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, this.meshHeightMultiplier, this.meshHeightCurve, this.levelOfDetail), TextureGenerator.TextureFromColorMap(mapData.colorMap, mapChunkSize, mapChunkSize));
        }
    }
    ...
    {
        MeshData meshData = MeshGenerator.GenerateTerrainMesh(mapData.heightMap, this.meshHeightMultiplier, this.meshHeightCurve, this.levelOfDetail);
